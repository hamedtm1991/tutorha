                                        ...
                                        <div class="my-container">
                                            <div id="my-inputs" class="my-inputs">
                                                <div id='inputs' style="font-size: 35px">
                                                    <input id='input1' class="auth-input p-0" type='tel' maxLength="1" />
                                                    <input id='input2' class="auth-input p-0" type='tel' maxLength="1" />
                                                    <input id='input3' class="auth-input p-0" type='tel' maxLength="1" />
                                                    <input id='input4' class="auth-input p-0" type='tel' maxLength="1" />
                                                </div>
